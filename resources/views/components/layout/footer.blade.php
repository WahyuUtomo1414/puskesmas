            ...
            <div class="flex flex-wrap mx-[-15px] !mt-[-30px] xl:!mt-0 lg:!mt-0">
                ...
                <div class="md:w-4/12 lg:w-2/12 xl:w-2/12 w-full flex-[0_0_auto] !px-[15px] max-w-full max-lg:!mt-[30px]">
                    <div class="widget">
                        ...
                        <address class=" not-italic !leading-[inherit] !mb-4">Karang Endah, Kec. Semendawai Suku III, Kabupaten Ogan Komering Ulu Timur, Sumatera Selatan</address>
                        <a class="!text-[#cacaca] hover:!text-[#3f78e0]">085266430643</a>
                    </div>
                <!-- /.widget -->
                </div>
                <!-- /column -->
